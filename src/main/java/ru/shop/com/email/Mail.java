...
public class Mail
{
    ...
    public static void sendEmail(String text,String to) throws IOException, MessagingException {
        ...
        message.setSubject("Код подтвержения с сайта BodaShop.com");
